...
import { collection, query, onSnapshot, orderBy, addDoc, updateDoc, doc, deleteDoc, Timestamp, getDocs } from 'firebase/firestore';
...
export default function Tasks({ user, users }: TasksProps) {
    ...
    >
      ...
      <div className="space-y-3 pt-4 border-t border-slate-50">
        ...
        <div className="flex items-center gap-2">
          ...
          {task.leadName && (
            <button 
              onClick={() => task.leadId && navigate(`/lead/${task.leadId}`)}
